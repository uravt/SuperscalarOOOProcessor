...
EXE_NAME=processor
SRCS := main.cpp memory.cpp memory_ooo.cpp processor.cpp processorOOO.cpp instruction_queue.cpp reorder_buffer.cpp non_blocking_cache.cpp load_store_queue.cpp
OBJS := $(SRCS:.cpp=.o)

ZIP_NAME = submission.zip
ZIP_FILES = main.cpp memory.cpp memory_ooo.cpp processor.cpp processorOOO.cpp instruction_queue.cpp reorder_buffer.cpp non_blocking_cache.cpp load_store_queue.cpp regfile.h ALU.h control.h processor.h processorOOO.h memory.h memory_ooo.h reorder_buffer.h prf.h instruction_queue.h functional_units.h non_blocking_cache.h load_store_queue.h config.h Makefile
...
memory.o: memory.h
memory_ooo.o: memory_ooo.h memory.h config.h
